...
UI.prototype.videoContols = function(){
...
UI.prototype.addCustomer = function(customer){
    ...
    div.innerHTML = `<img src="img/osoba-${random}.jpg" alt="person" class="person__thumbnail">
...
UI.prototype.showModal = function(event){
    ...
    if(event.target.parentElement.classList.contains('work-item__icon')){
        ...
        modalItem.style.backgroundImage = `url(/img/posao${id}.jpg)`
    }
}
